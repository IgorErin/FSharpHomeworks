...
[<assembly: AssemblyTitleAttribute("FSharpHomeworks.Tests")>]
[<assembly: AssemblyProductAttribute("FSharpHomeworks")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "FSharpHomeworks.Tests"
    let [<Literal>] AssemblyProduct = "FSharpHomeworks"
